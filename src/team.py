...
class Team:
    ...
    def calculate_total_score(self, matchday: int) -> float:
        """
        Calculate total team score for a matchday including defense modifier.
        """
        if matchday not in self.lineup:
        ...
        defense_modifier = self.calculate_defense_modifier(matchday)
        total_score += defense_modifier
        
        self.total_scores[matchday] = total_score
        return total_score
    
    def get_lineup_summary(self, matchday: int) -> str:
        """
        ...
        summary += f"\nDefense Modifier: +{defense_modifier}"
